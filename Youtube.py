...
api_key='AIzaSyDCVBO_avNeQHCAVl_EOBjLUK6Ivm6I-a0' #your API key here
...
host = 'localhost'
port = '5432'
database = 'postgres' #the database youcreated
...
omega=pymongo.MongoClient("mongodb://localhost:27017") #copy the link from mongodb  to establish connection and enter your password
...
#and stores all the data in a collection in mongodb
...
with st.sidebar:
    ...
    st.caption(" Data Managment using MongoDB  and SQL created by Rakesh.G")
